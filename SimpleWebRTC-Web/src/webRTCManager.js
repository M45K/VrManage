...
class WebRTCManager {
  ...
  async handleMessage(data) {
    const rawText = typeof data === "string" ? data : data.data;
    console.log(`Received WebSocket message: ${rawText}`);
    const signalingMessage = new SignalingMessage(rawText);
  ...
  async initiateOffersToAllPeers() {
    ...
    console.log("Peers attuali:", Array.from(this.peerConnections.keys()));
